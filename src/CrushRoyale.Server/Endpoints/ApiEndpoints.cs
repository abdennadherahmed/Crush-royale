...
public static class ApiEndpoints
{
    ...
    private static void MapStory(RouteGroupBuilder api)
    {
        ...
        api.MapPost(ApiRoutes.RestorationBuild, (RestorationBuildRequest body, ClaimsPrincipal user, StoryService s, CancellationToken ct) => s.BuildRestorationAsync(Me(user), body, ct));
    ...
    private static void MapEconomy(RouteGroupBuilder api)
    {
        ...
        api.MapPost(ApiRoutes.PetConvert, (PetConvertRequest body, ClaimsPrincipal user, PetService s, CancellationToken ct) => s.ConvertAsync(Me(user), body, ct));
